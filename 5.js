...
PageCode["dom"] = {
  title: 'Перенос домика на следующий вайп',
  content: '<div class="xbox_custom_rules"><ul style="list-style-type:disc"> <h4>Информация</h4> <li>Вы автоматически соглашаетесь со всеми нижеперечисленными пунктами правил.</li></br><li>1) Местность для домика должна быть максимально ровной.</li></br><li>3) Все что рядом с домиком не сохранится (не факт, что-то сохраняется, что-то нет, машины тоже переносятся, но могут быть сломаны).</li></br><li>4) Можно переносить 1 домик (если решите  перенести второй и последующие домики, то будет считаться с той же ценой что и за 1 домик).</li></br><li>5) Нельзя переносить огромные базы с чрезмерно большим количеством ресурсов, а так же домики с чрезмерно большим количеством ресурсов.</li></br><li>6) Стоимость работ 6500 за домик с ресурсами, 800р за домик без ресурсов(домики можно переносить каждый вайп).</li></br><li>7) Скидки с магазина применяются при желании.</li></br><li>8) Это является добровольным пожертвованием .</li></br><li>6) Раздел будет дополняться...</li></br>   <h4>Как будет все происходить?</h4>    <li>Вы связываетесь с администратором перед вайпом за часа 4-6 с вопросом "Можно ли перенести домик на следующий вайп?"</li></br><li>Администратор узнает что ему нужно, вы оплачиваете работу, присылаете скриншот.</li></br><li>После вайпа вы ищите место где хотите поставить домик, связываетесь с админом или админ сам свяжется и начнется процесс переноса</li> <br><li>Процесс переноса представляет перенос полной копии домика, с тем что внутри (ящики, ресурсы и все прочее, что вы собирали)</li></br></br></div>'
};
PageCode["help"] = {
  title: 'КОМАНДЫ',
...
PageCode["block"] = {
  title: 'БОНУСЫ', 
  content: '<div class="xbox_custom_rules"><ul style="list-style-type:disc"> <h4>БОНУСЫ</h4> <li>Префикс "RZMX" - даёт VIP привелегию на 1 день</li></br><li>Промокод "wipe" - даёт 7% скидки на все</li></br><li> Общая сумма пополнение на 5000₽ добавит вам еще 2000₽!!!</li></br><li>Разовое пополнение на 1000₽ прибавит вам еще 500₽!!!</li></br></ul></br></br></br></div>'
};
PageCode["kit-free"] = {
